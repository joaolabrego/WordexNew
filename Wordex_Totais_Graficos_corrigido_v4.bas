...
Private Sub Totais_EscreverResultado( _
    ...
    For i = LBound(colunasTotalizadoras) To UBound(colunasTotalizadoras)
        ...
        For j = LBound(valoresCalcular) To UBound(valoresCalcular)
            ...
            Totais_EscreverCabecalhoTotal destino, origem, colunaOrigem, colunaDestino, nomeTotal, tipoTotal, gerarParaGrafico
        Next j
    Next i
    ...
    For Each chave In grupos.Keys
        ...
        For i = LBound(colunasTotalizadoras) To UBound(colunasTotalizadoras)
            ...
            For j = LBound(valoresCalcular) To UBound(valoresCalcular)
                ...
                Totais_EscreverValorTotal destino, linhaDestino, colunaDestino, nomeTotal, valorTotal, gerarParaGrafico
            Next j
        Next i
