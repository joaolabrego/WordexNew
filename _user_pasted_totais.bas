...
Private Function Wordex_JsonNumeroInvariant(ByVal valor As Variant) As String
    ...
    sepMilhar = Application.ThousandsSeparator
    ...
    If sepMilhar <> vbNullString And sepMilhar <> sepDecimal Then
    ...
    Wordex_JsonNumeroInvariant = Wordex_JsonAjustarZerosEsquerdaNumero(texto)
End Function

Private Function Wordex_JsonNormalizarNumeroTexto( _
    ByVal texto As String, _
    ByRef numeroJson As String _
) As Boolean
    ...
    ElseIf posVirgula > 0 Then
        ' Sem ponto: assume vírgula como decimal.
        s = Replace$(s, ".", vbNullString)
        s = Replace$(s, ",", ".")

    ElseIf posPonto > 0 Then
        ' Sem vírgula: assume ponto como decimal.
        s = Replace$(s, ",", vbNullString)
    End If
