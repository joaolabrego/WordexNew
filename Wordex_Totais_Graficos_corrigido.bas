...
Public Sub GerarAbaTotais( _
    ...
    Totais_EscreverResultado destino, origem, grupos, valoresGrupos, colunasAgrupadoras, colunasTotalizadoras, gerarParaGrafico
End Sub
...
Private Sub Totais_EscreverResultado( _
    ...
    For i = LBound(colunasTotalizadoras) To UBound(colunasTotalizadoras)
        ...
        Totais_EscreverCabecalhoTotal destino, origem, colunaOrigem, colunaDestino, campo & "Count", "Count", gerarParaGrafico
        Totais_EscreverCabecalhoTotal destino, origem, colunaOrigem, colunaDestino, campo & "Sum", "Sum", gerarParaGrafico
        Totais_EscreverCabecalhoTotal destino, origem, colunaOrigem, colunaDestino, campo & "Min", "Min", gerarParaGrafico
        Totais_EscreverCabecalhoTotal destino, origem, colunaOrigem, colunaDestino, campo & "Max", "Max", gerarParaGrafico
        Totais_EscreverCabecalhoTotal destino, origem, colunaOrigem, colunaDestino, campo & "Avg", "Avg", gerarParaGrafico
    Next i
    ...
    For Each chave In grupos.Keys
        ...
        For i = LBound(colunasTotalizadoras) To UBound(colunasTotalizadoras)
            ...
            nomeTotal = campo & "Count"
            Totais_EscreverValorTotal destino, linhaDestino, colunaDestino, nomeTotal, countValue, gerarParaGrafico

            nomeTotal = campo & "Sum"
            Totais_EscreverValorTotal destino, linhaDestino, colunaDestino, nomeTotal, sumValue, gerarParaGrafico

            nomeTotal = campo & "Min"
            Totais_EscreverValorTotal destino, linhaDestino, colunaDestino, nomeTotal, Totais_ValorOuVazio(stats, nomeTotal), gerarParaGrafico
            ...
            Else
                avgValue = vbNullString
            End If
            Totais_EscreverValorTotal destino, linhaDestino, colunaDestino, nomeTotal, avgValue, gerarParaGrafico
        Next i
...
Private Sub Totais_EscreverCabecalhoTotal( _
    ...
    If gerarParaGrafico Then
        ...
        Totais_AplicarFormatoValorGrafico destino, colunaDestino
        colunaDestino = colunaDestino + 1
...
Private Sub Totais_EscreverValorTotal( _
    ...
    If gerarParaGrafico Then
        ...
        destino.Cells(linhaDestino, colunaDestino).Value = nomeTotal
        colunaDestino = colunaDestino + 1
    End If
End Sub

Private Sub Totais_AplicarFormatoValorGrafico(ByRef destino As Worksheet, ByVal colunaDestino As Long)
